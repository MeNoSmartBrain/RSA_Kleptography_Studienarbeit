...
\section{Mathematik}
    ...
    % Wahrscheinlichkeit dass Zufallszahl gleich prim
    % Laufzeit für die Generierung von Primzahlen
    % Laufzeit für Primzahltest
    % Definition von prim

    % p für Keine modulare Multiplikative Inverse
